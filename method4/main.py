...
pix_full = np.array([
    [1192, 1648], # top-left corner of the plate (origin)
    [1440, 1656], # top-right corner of the plate
    [1180, 1720], # bottom-left corner of the plate
    [1432, 1712], # bottom-right corner of the plate
    [1036, 1592], # left rear light
    [1612, 1608], # right rear light
    [1928, 1340]  # optional: right side mirror
], dtype=np.float32)
